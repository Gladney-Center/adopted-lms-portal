...
module.exports = __webpack_require__("r5VE");
...
/* harmony default export */ var Portal = __webpack_exports__["a"] = (({
  ...
  const router = Object(router_["useRouter"])(),
    ...
    window.localStorage.setItem('portalSettings', stringify_default()(assign_default()(settings, {
      theme: theme
    })));
  };
...
// EXTERNAL MODULE: ./components/Portal/index.js + 3 modules
...
// CONCATENATED MODULE: ./pages/[route].js
...
const PortalPage = props => {
  const router = Object(router_["useRouter"])();
  return __jsx(Portal["a" /* default */], null, __jsx("main", {
    className: "shmoop"
  }, __jsx("h3", null, router.query.route)));
};

PortalPage.getInitialProps = async ({
  req,
  res
}) => {
  const firebs = await firebase["a" /* default */].firestore().collection('/classSections');
...
/* harmony default export */ var _route_ = __webpack_exports__["default"] = (PortalPage);

...
var META = __webpack_require__("Jcj/").KEY;
var $fails = __webpack_require__("Jizj");
var shared = __webpack_require__("TCYi");
var setToStringTag = __webpack_require__("BUZC");
var uid = __webpack_require__("275m");
var wks = __webpack_require__("hl9K");
var wksExt = __webpack_require__("l2gV");
var wksDefine = __webpack_require__("hod8");
var enumKeys = __webpack_require__("zW5p");
...
var _create = __webpack_require__("20n8");
var gOPNExt = __webpack_require__("VGVX");
var $GOPD = __webpack_require__("kYzV");
...
if (!USE_NATIVE) {
  ...
  $DP.f = $defineProperty;
  __webpack_require__("yyhP").f = gOPNExt.f = $getOwnPropertyNames;
  __webpack_require__("3EnH").f = $propertyIsEnumerable;
  $GOPS.f = $getOwnPropertySymbols;

  if (DESCRIPTORS && !__webpack_require__("uTcf")) {
...
$Symbol[PROTOTYPE][TO_PRIMITIVE] || __webpack_require__("kQ04")($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
...
const PageContext = Object(external_react_["createContext"])();
/* harmony default export */ var context = (PageContext);
...
class _app_AdptApp extends app_default.a {
  constructor(...args) {
    super(...args);
  ...
  componentDidMount() {
    this.itemsRef = firebase["a" /* default */].firestore().collection('/pages').onSnapshot(snapshot => {
      let obj = {};
      snapshot.forEach(sn => {
        obj[sn.id] = sn.data();
      });
  ...
  render() {
    ...
    }), __jsx("title", null, process.env.BASE_TITLE), __jsx("link", {
      rel: "stylesheet",
...
var toIObject = __webpack_require__("dleS");
var gOPN = __webpack_require__("yyhP").f;
...
/* harmony default export */ __webpack_exports__["a"] = (!firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.apps.length ? firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializeApp(config) : firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.app());
...
var LIBRARY = __webpack_require__("uTcf");
var wksExt = __webpack_require__("l2gV");
var defineProperty = __webpack_require__("6s2L").f;
...
exports.f = __webpack_require__("hl9K");
...
__webpack_require__("0a3d");
module.exports = __webpack_require__("5e9t").Object.getOwnPropertySymbols;
...
module.exports = __webpack_require__("pK69");
...
var $keys = __webpack_require__("Fndd");
var hiddenKeys = __webpack_require__("yHAa").concat('length', 'prototype');
